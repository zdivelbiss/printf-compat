...
impl Length {
    unsafe fn parse_signed(self, args: &mut VaList) -> SignedInt {
        match self {
            ...
            Length::Char => SignedInt::Char(args.arg::<c_int>() as i8),
            Length::Short => SignedInt::Short(args.arg::<c_int>() as i16),
    ...
    unsafe fn parse_unsigned(self, args: &mut VaList) -> UnsignedInt {
        match self {
            ...
            Length::Char => UnsignedInt::Char(args.arg::<c_int>() as u8),
            Length::Short => UnsignedInt::Short(args.arg::<c_int>() as u16),
    ...
    for (sub, next) in iter.map(Some).chain(core::iter::once(None)).tuple_windows() {
        ...
        err!(handler(Argument {
            ...
            specifier: match ch {
                ...
                b'c' => Specifier::Char(args.arg::<c_int>() as u8),
